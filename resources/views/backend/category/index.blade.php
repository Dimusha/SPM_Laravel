...
@section('main-content')
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Category Lists 
      </h6>
       </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        <a href="#" class=" btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> Generate PDF</a>
