...
@section('title','Saved Items Page')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Saved Items</a></li>
						</ul>
					</div>
				</div>
			</div>
							...
							@else
								<tr>
									<td class="text-center">
										There are no any Saved Items available. <a href="{{route('product-grids')}}" style="color:blue;">Continue shopping</a>
