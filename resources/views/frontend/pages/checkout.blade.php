                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country">
                                                <option value="AF">Malabe</option>
                                                <option value="AX">Kaduwela</option>
                                                <option value="AL">Kottawa</option>
                                                <option value="DZ">Maharagama</option>
                                                <option value="AQ">Homagama</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                ...
                                                <input name="payment_method"  type="radio" value="payPal"> <label>Pay Pal</label><br>
                                                <label><b>If you are using Online Payment, please click here......</b></label><br>
                                            </form-group>
                                            <div class="single-widget get-button">
                                                <div class="content">
                                                    <div class="button">
                                                        <a href="{{route('cardDetails')}}" class="btn">Enter card details</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
