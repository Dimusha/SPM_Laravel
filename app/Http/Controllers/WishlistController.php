...
class WishlistController extends Controller
{
    ...
    public function wishlist(Request $request){
        ...
        if($already_wishlist) {
            request()->session()->flash('error','You already placed in Saved List');
            return back();
        }else{
        ...
        request()->session()->flash('success','Product successfully Saved');
        return back();
    }
    ...
    public function wishlistDelete(Request $request){
        ...
        if ($wishlist) {
            $wishlist->delete();
            request()->session()->flash('success','Successfully removed from Saved Items');
            return back();
        }
